    ...
    public static boolean menu(int op) {
        switch (op) {
            ...
            case 3 ->
                listarFiguras();
            case 4 -> {
                System.out.println("Esto es debido a lo que llamamos  sobrecarga, que es cuando tenemos varios metodos con el mismo\n"
                        + "¿Cuál es la diferencia entre polimorfismo por sobreescritura, interfaces y clases abstractas? (2 puntos)\n"
                        + "La diferencia es que con sobreescritura se usa especialmente con metodos que tiene las clase padre,"
                        + "con abstractas creamos una clase que no se puede insrtanciar como clase base y a partir de ella crear otras, "
                        + "e interfaces es un apartado de metodos que mandan a llamar los atributos de la clase padre.\n"
                        + "¿Qué es la sobrecarga de Métodos? (1 punto)\nCCuando tenemos dos o mas metodos con el mismo nombre, pero sus "
