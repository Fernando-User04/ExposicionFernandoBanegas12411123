                                ...
                                do {
                                    ...
                                    switch(opc){
                                        ...
                                        case 3:
                                            ...
                                            global.get(numerodealumno).setInasistencias(cantidad);
                                            break;
                                        default:
                                            System.out.println("Opcion no valida, intente nuevamente");
                                            break;
                            ...
                            case 1:
                                ...
                                for (int i = 0; i < clases.size(); i++) {
                                    ...
                                    if (clases.get(i).getLista()==null) {
                                        ...
                                        for (int j = 0; j < clases.get(i).getLista().size(); j++) {
                                            System.out.println((j+1)+". "+clases.get(i).getLista().get(j).getNumero()+""
                                                + " ( "+clases.get(i).getLista().get(j).getInasistencias()+" Inasistencias ) ");
                                            System.out.println("");
                                        }
                                        System.out.println("");
                                        System.out.println("");
                    ...
                    do {
                        ...
                        switch(resp4){
                            case 1:
                                ...
                                System.out.println("");
                                for (int i = 0; i < clases.size(); i++) {
                                    System.out.println((i+1)+". "+clases.get(i).getNombre()+" - "+clases.get(i).getSeccion());
                                    System.out.println("");
                                }
